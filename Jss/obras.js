const preguntas = [
    {
      ...
      respuestas: ["William Shakespeare","Lope de la Vega","Miguel de Cervantes","Julio Ramon Riveyro"],
      correcta: 2
    },
    {
      pregunta: "¿Quién escribió los Heraldos Negros?",
      respuestas: ["Patricia Llosa","César Vallejo","Mario Vargas Llosa","Gabriel García Márquez"],
      correcta: 1
    },
    {
      pregunta: "¿Quién ganó el premio Nobel de literatura Peruana?",
      respuestas: ["Pablo Neruda","Abraham Valdelomar","Mario Vargas Llosa","Ricardo Palma"],
      correcta: 2
    }
